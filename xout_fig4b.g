...
function make_currgraph
    ...
    create xgraph /xout/curr/activations -xgeom 0:current -ygeom 0:label -hgeom 90% -wgeom 50%
    setfield ^ XUnits sec YUnits M
    setfield ^ xmax {sim_time} ymin 0.0 ymax 1.0
    // create xgraph /xout/curr/conductances -xgeom 0:activations -ygeom 0:label -hgeom 90% -wgeom 33%
    // setfield ^ XUnits sec YUnits M
    // setfield ^ xmax {sim_time}
        // setfield ^ xmax {sim_time} ymin -2e-9 ymax 2e-9
...
addmsg /neuron/soma/KNa_slow /xout/curr/activations PLOT Z *KNaS(soma) *red
addmsg /neuron/soma/KCa_N /xout/curr/activations PLOT Z *KCaN(soma) *blue 
